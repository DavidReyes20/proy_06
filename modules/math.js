...
//definimos la funcion flecha invertirNumeroComoTexto como constante con parametro numero
const invertirNumeroComoTexto = numero => {
    //definimos numeroInvertidoComoTexto como constante de tipo texto
    const numeroInvertidoComoTexto = numero.toString().split("").reverse().join("").yellow;
    //me devuelve el valor numeroInvertidoComoTexto
    return numeroInvertidoComoTexto;
};

//Definimos la funcion flecha invertirTexto como constante con parametro texto
...
const conversionDatos = data => {
    ...
    /*Declaramos la condicinal if que evaluara lo que esta dentro de la variable que tiene ciertas 
